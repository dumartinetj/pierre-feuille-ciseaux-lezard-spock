...
<?php if ($temps_attente>20) echo '<h4><a href="<?php $_SERVER['PHP_SELF']; ?>?action=annulerPartie">Temps d\'attente trop long ? Annuler la partie !</a></h4>'; ?>
<h5>Cette page s'actualisera automatiquement toutes les 3 secondes...</h5>
<form name="waitingCoup" id="waitingCoup" action="<?php $_SERVER['PHP_SELF']; ?>?action=waitingCoup" method="POST">
